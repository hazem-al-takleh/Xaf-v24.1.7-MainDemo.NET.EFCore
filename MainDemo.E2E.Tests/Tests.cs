...
public class MainDemoTests : IDisposable {
    ...
    public MainDemoTests() {
        ...
        FixtureContext.RegisterDatabases(new DatabaseOptions(MainDemoDBName, "MainDemo.NET.EFCore_v24.1", server: "(localdb)\\mssqllocaldb"));
    }
    public void Dispose() {
    ...
    public void CheckSaveActionState(string applicationName) {
        ...
        Assert.Equal("Save", appContext.GetAction("Save").Hint);
